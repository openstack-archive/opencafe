...
class BaseSSHClient(BaseClient):
    ...
    def wait_for_active_shell(self):
        """
        Opens a channel and waits until max_time for the chanel
    ...
    def retrieve_exit_status_on_shell_response(self):
        '''
        If the chanel is ready to provide exit status, this function
        retrieves it.
        '''
    ...
    def execute_shell_command(self, cmd, timeout=100, sleep_interval=5):
        ...
        #Wait until the command execution to complete. Channel would be close
        # once that happens.
