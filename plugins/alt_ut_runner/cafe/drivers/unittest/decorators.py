...
def _add_tags(func, tags):
    func.__test_tags__ = getattr(func, TAGS_DECORATOR_TAG_LIST_NAME, [])
    func.__test_tags__ += tags
    func.__test_tags__ = list(set(func.__test_tags__))
    return func
...
def data_driven_test(*dataset_sources, **kwargs):
    ...
    def decorator(func):
        ...
        for key, value in kwargs:
            if getattr(value, "apply_test_tags", None) is not None:
