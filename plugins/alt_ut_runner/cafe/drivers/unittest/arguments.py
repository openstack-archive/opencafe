...
def tree(directory, padding):
    ...
    slash = "/" if os.path.isdir(dir_path) else ""
    print("{0}{1}{2}".format(dir_token, dir_path, slash))
    ...
    if os.path.isdir(dir_path)
        ...
        print("tree: {0} Does Not Exist".format(directory), file=stderr)
