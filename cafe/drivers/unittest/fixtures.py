...
class BaseTestFixture(unittest.TestCase, ReportingFixtureMixin):
    """
    ...
    def setUp(self):
        ...
        self.start_test_metrics(self._testMethodName, self.logDescription())
    ...
    def tearDown(self):
        ...
        if any(r for r in self._resultForDoCleanups.failures
            ...
            self.end_test_metrics(self._testMethodName, 'Failed')
        elif any(r for r in self._resultForDoCleanups.errors
                 if self._test_name_matches_result(self._testMethodName, r)):
            self.end_test_metrics(self._testMethodName, 'ERRORED')
        else:
            self.end_test_metrics(self._testMethodName, 'Passed')
