...
class TestEnvManager(object):
    ...
    value to enabled overrides for other managed env vars.

    NOTE: DO THIS WITH CAUTION, AS IT IS EASY TO MESS THINGS UP!
          If you set CAFE_TEST_REPO_PATH, you must
          also set CAFE_TEST_REPO_PACKAGE or undefined behavior will ensue.
    """

    MANAGED_VARS = _Namespace(
    ...
    def __init__(
        ...
        # Special case attributes that need direct overriding here.
        ...
        self.engine_config_path = engine_config_path or override or \
    ...
    def test_data_directory(self):
        return self._override(self.MANAGED_VARS.test_data_directory) \
            or os.path.expanduser(self.engine_config_interface.data_directory)

    @_lazy_property
    def test_root_log_dir(self):
        return self._override(self.MANAGED_VARS.test_root_log_dir) \
    ...
    def test_config_file_path(self):
        return self._override(self.MANAGED_VARS.test_config_file_path) \
            or os.path.expanduser(
                os.path.join(
    ...
    def test_logging_verbosity(self):
        ...
        """
        return self._override(self.MANAGED_VARS.test_logging_verbosity) \
            or self.engine_config_interface.logging_verbosity

    @_lazy_property
    def test_master_log_file_name(self):
        return self._override(self.MANAGED_VARS.test_master_log_file_name) \
