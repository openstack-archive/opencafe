...
warnings.showwarning = lambda msg, category, filename, lineno: sys.stderr.write(str(msg))
...
def getLogger(log_name, log_level=None):
    ...
    if not verbosity:
        warnings.warn(
            "\nEnvironment variable 'CAFE_LOGGING_VERBOSITY' is not set. "
            "'STANDARD' will be used by default.\n", Warning)
