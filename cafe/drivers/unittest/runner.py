...
class SuiteBuilder(object):
    ...
    def get_classes(self, loaded_module):
        ...
        then filters of path. Filter passed in with -D
        """
        classes = []
    ...
    def get_cl_args(self):
        ...
        *list tests for a product
        ...
        argparser.add_argument(
            ...
            help="Package Filter. -p will be deprecated by -D.")

        argparser.add_argument(
            "-m", "--module-regex", "--module",
            default="",
            metavar="<string filter>",
            help="Test module filter. -m will be deprecated by -D.")
        ...
        argparser.add_argument(
            ...
            default=[],
            metavar="<string filter>",
            help="Dotpath filters allow regex filtering base on the path to "
                 "the class. For example if dotpath equals cloudroast.identity"
                 ".v2_0.smoke.AdminIdentityServiceSmoke filter can be "
                 "'smoke.Admin.*' and it would match")
