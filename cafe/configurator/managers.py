...
class TestEnvManager(object):
    ...
    def test_repo_path(self, test_repo_path=None):
        """NOTE:  There is not default for test_repo_path because we don't
    ...
    def test_root_log_dir(self, test_root_log_dir=None):
        self.test_root_log_dir = test_root_log_dir or os.path.join(
            self.engine_config_interface.logging_directory, self.product_name,
    ...
    def test_log_dir(self, test_log_dir=None):
        ...
        self.test_root_log_dir = self.test_root_log_dir or \
            self.engine_config_interface.logging_directory
