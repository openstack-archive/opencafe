...
class _UnittestRunnerCLI(object):
    ...
    class ListAction(argparse.Action):
        def __call__(self, parser, namespace, values, option_string=None):
            ...
            product_config_dir = os.path.join(
                test_env_mgr.engine_config_interface.config_directory, product)
    ...
    def get_cl_args(self):
        ...
        *list tests and configs for a product
        ...
        if (args.result or args.result_directory) and (args.result is None or args.result_directory is None):
            print argparser.usage
            print (
